...
namespace VoxelVerse 
{
    ...
    [RoomType("VoxelVerse")]
    public class VoxelVerseServer : Game<Player> 
    {

        private const String RELAY_TO_PEERS             = "rtp";
        private const String MOVE_MESSAGE               = "mov";
        private const String PROJECTILE_SHOT_MESSAGE    = "psm";
		private const String YOUR_ID                    = "yid";
        private const String ADD_ME                     = "add";

        private const String USER_JOINED                = "UserJoined";
		...
		public override void UserJoined(Player player) {
            ...
            Console.WriteLine("UserJoined: " + player);
		}
		...
		public override void GotMessage(Player player, Message message) {
            Console.WriteLine("message.Type: " + message.Type + "  player: " + player.Id );
            switch (message.Type)
            {
